...
void 
giveProcTickets(struct proc *p, int n)
{
...
scheduler(void)
{
  ...
  acquire(&ptable.lock);
  giveProcTickets(&ptable.proc[0], 1); //init ticket is 1
  release(&ptable.lock);
