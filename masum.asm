...
int main(int argc, char *argv[])
{
  ...
  12:	53                   	push   %ebx
    struct pstat info;
    getpinfo(&info);
  13:	8d 85 e8 fb ff ff    	lea    -0x418(%ebp),%eax
  19:	8d 9d e8 fc ff ff    	lea    -0x318(%ebp),%ebx
{
  1f:	51                   	push   %ecx
  20:	8d b5 e8 fd ff ff    	lea    -0x218(%ebp),%esi
  26:	81 ec 18 04 00 00    	sub    $0x418,%esp
    getpinfo(&info);
  2c:	50                   	push   %eax
  2d:	e8 69 03 00 00       	call   39b <getpinfo>
   //  printf(1, "%d running processes\n", info.num_processes);
    printf(1, "PID\tTICKETS\tTICKS\n");
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	68 c8 07 00 00       	push   $0x7c8
  39:	6a 01                	push   $0x1
  3b:	e8 20 04 00 00       	call   460 <printf>
    for(int i =0; i<NPROC; i++) {
  40:	83 c4 10             	add    $0x10,%esp
  43:	eb 0a                	jmp    4f <main+0x4f>
  45:	8d 76 00             	lea    0x0(%esi),%esi
  48:	83 c3 04             	add    $0x4,%ebx
  4b:	39 f3                	cmp    %esi,%ebx
  4d:	74 2d                	je     7c <main+0x7c>
       if(info.pid[i]!=0) {
  4f:	8b 83 00 01 00 00    	mov    0x100(%ebx),%eax
  55:	85 c0                	test   %eax,%eax
  57:	74 ef                	je     48 <main+0x48>
          printf(1, "%d\t%d\t%d\n", info.pid[i], info.tickets[i], info.ticks[i]);
  59:	83 ec 0c             	sub    $0xc,%esp
  5c:	ff b3 00 02 00 00    	pushl  0x200(%ebx)
  62:	83 c3 04             	add    $0x4,%ebx
  65:	ff 73 fc             	pushl  -0x4(%ebx)
  68:	50                   	push   %eax
  69:	68 db 07 00 00       	push   $0x7db
  6e:	6a 01                	push   $0x1
  70:	e8 eb 03 00 00       	call   460 <printf>
  75:	83 c4 20             	add    $0x20,%esp
    for(int i =0; i<NPROC; i++) {
  78:	39 f3                	cmp    %esi,%ebx
  7a:	75 d3                	jne    4f <main+0x4f>
   //  printf(1, "%d running processes\n", info.num_processes);
   //  printf(1, "PID\tTICKETS\tTICKS\n");
