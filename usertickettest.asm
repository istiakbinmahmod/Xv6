...
_usertickettest:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  14:	8d 9d e8 fb ff ff    	lea    -0x418(%ebp),%ebx
{
  1a:	51                   	push   %ecx
  1b:	81 ec 18 04 00 00    	sub    $0x418,%esp
   int pid = getpid();
  21:	e8 cd 03 00 00       	call   3f3 <getpid>
   check(getpinfo(&st) == 0, "getpinfo");
  ...
  2a:	89 c7                	mov    %eax,%edi
   check(getpinfo(&st) == 0, "getpinfo");
  2c:	e8 ea 03 00 00       	call   41b <getpinfo>
  31:	83 c4 10             	add    $0x10,%esp
  34:	85 c0                	test   %eax,%eax
  36:	74 23                	je     5b <main+0x5b>
  38:	83 ec 0c             	sub    $0xc,%esp
  3b:	68 48 08 00 00       	push   $0x848
  40:	6a 10                	push   $0x10
  42:	68 51 08 00 00       	push   $0x851
  47:	68 8c 08 00 00       	push   $0x88c
  4c:	6a 01                	push   $0x1
  4e:	e8 8d 04 00 00       	call   4e0 <printf>
  53:	83 c4 20             	add    $0x20,%esp
  56:	e8 18 03 00 00       	call   373 <exit>

   printf(1, "\n **** PInfo **** \n");
  5b:	51                   	push   %ecx
  5c:	8d b5 e8 fc ff ff    	lea    -0x318(%ebp),%esi
  62:	51                   	push   %ecx
  63:	68 62 08 00 00       	push   $0x862
  68:	6a 01                	push   $0x1
  6a:	89 85 e4 fb ff ff    	mov    %eax,-0x41c(%ebp)
  70:	e8 6b 04 00 00       	call   4e0 <printf>
   int i;
   for(i = 0; i < NPROC; i++) {
  75:	8b 85 e4 fb ff ff    	mov    -0x41c(%ebp),%eax
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	eb 07                	jmp    87 <main+0x87>
  80:	83 c3 04             	add    $0x4,%ebx
  83:	39 f3                	cmp    %esi,%ebx
  85:	74 41                	je     c8 <main+0xc8>
      if (st.inuse[i]) {
  87:	8b 13                	mov    (%ebx),%edx
  89:	85 d2                	test   %edx,%edx
  8b:	74 f3                	je     80 <main+0x80>
        if(st.pid[i] == pid) {
  8d:	39 bb 00 02 00 00    	cmp    %edi,0x200(%ebx)
  93:	75 eb                	jne    80 <main+0x80>
          defaulttickets = st.tickets[i];
  95:	8b 83 00 01 00 00    	mov    0x100(%ebx),%eax
          printf(1, "pid: %d tickets: %d ticks: %d\n", st.pid[i], st.tickets[i], st.ticks[i]);
  9b:	83 ec 0c             	sub    $0xc,%esp
  9e:	ff b3 00 03 00 00    	pushl  0x300(%ebx)
  a4:	83 c3 04             	add    $0x4,%ebx
  a7:	50                   	push   %eax
  a8:	57                   	push   %edi
  a9:	68 bc 08 00 00       	push   $0x8bc
  ae:	6a 01                	push   $0x1
  b0:	89 85 e4 fb ff ff    	mov    %eax,-0x41c(%ebp)
  b6:	e8 25 04 00 00       	call   4e0 <printf>
  bb:	8b 85 e4 fb ff ff    	mov    -0x41c(%ebp),%eax
  c1:	83 c4 20             	add    $0x20,%esp
   for(i = 0; i < NPROC; i++) {
  c4:	39 f3                	cmp    %esi,%ebx
  c6:	75 bf                	jne    87 <main+0x87>
         }
      }
   }
  ...
  cb:	74 23                	je     f0 <main+0xf0>
  cd:	83 ec 0c             	sub    $0xc,%esp
  d0:	68 dc 08 00 00       	push   $0x8dc
  d5:	6a 1d                	push   $0x1d
  d7:	68 51 08 00 00       	push   $0x851
  dc:	68 18 09 00 00       	push   $0x918
  e1:	6a 01                	push   $0x1
  e3:	e8 f8 03 00 00       	call   4e0 <printf>
  e8:	83 c4 20             	add    $0x20,%esp
  eb:	e8 83 02 00 00       	call   373 <exit>
   printf(1, "Should print 1 then 2");
  f0:	50                   	push   %eax
  f1:	50                   	push   %eax
  f2:	68 76 08 00 00       	push   $0x876
  f7:	6a 01                	push   $0x1
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 50 09 00 00 	movzbl 0x950(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	eb 1a                	jmp    680 <printf+0x1a0>
          s = "(null)";
 666:	bb 46 09 00 00       	mov    $0x946,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b5:	a1 08 0c 00 00       	mov    0xc08,%eax
{
 ...
 6d6:	73 10                	jae    6e8 <free+0x38>
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	a3 08 0c 00 00       	mov    %eax,0xc08
}
 707:	5e                   	pop    %esi
 708:	5f                   	pop    %edi
 709:	5d                   	pop    %ebp
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 08 0c 00 00       	mov    %eax,0xc08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 74d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 750:	8b 3d 08 0c 00 00    	mov    0xc08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 799:	8b 3d 08 0c 00 00    	mov    0xc08,%edi
 ...
 7c2:	e8 e9 fe ff ff       	call   6b0 <free>
  return freep;
 7c7:	a1 08 0c 00 00       	mov    0xc08,%eax
 ...
 7f4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7f7:	a3 08 0c 00 00       	mov    %eax,0xc08
}
 ...
 80e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 08 0c 00 00 0c 	movl   $0xc0c,0xc08
 817:	0c 00 00 
    base.s.size = 0;
 81a:	bf 0c 0c 00 00       	mov    $0xc0c,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 0c 0c 00 00 0c 	movl   $0xc0c,0xc0c
 826:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 829:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 82b:	c7 05 10 0c 00 00 00 	movl   $0x0,0xc10
 832:	00 00 00 
    if(p->s.size >= nunits){
